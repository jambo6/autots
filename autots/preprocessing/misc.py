...
class PadRaggedTensors(TransformerMixin):
    ...
    If the input is a 3D tensor, reduces the num_samples of the sequence and ignores the padding step. If the object is a
    list of tensors (or numpy object), reduces the sequence num_samples then pads.
    """
    ...
    def transform(self, data):
        ...
        # Otherwise reduce num_samples and pad
            ...
            output = pad_sequence(
                data, batch_first=True, padding_value=self.fill_value
            )
        return output
